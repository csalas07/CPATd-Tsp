...
float* Memory::ReserveVectorflt(int size) {
	...
	if (!aux)
		abortar(2, (char*)"Error al reservar memoria a un vector float");
...
float** Memory::ReseveBiVectorflt(int row, int columns) {
	...
	if (!aux)
		abortar(2, (char*)"Error al reservar memoria a un Bivector float");
...
float*** Memory::ReseveTriVectorflt(int row, int columns, int tdim) {
	...
	if (!aux)
		abortar(2, (char*)"Error al reservar memoria a un Trivector float");
